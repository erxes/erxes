...
export async function getCustomerFieldsInfo(
  content: string,
  customer: ICustomer
): Promise<{ customerFields: string[]; customFieldsData: any[] }> {
  ...
  return { customerFields, customFieldsData };
}

export const generateReplacers = async (args: Args): Promise<IReplacer[]> => {
...
export const replaceContent = async (args: Args): Promise<string> => {
