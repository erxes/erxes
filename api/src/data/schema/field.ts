...
export const fieldsQueries = `
  ...
  fieldsCombinedByContentType(contentType: String!, usageType: String, excludedNames: [String], segmentId: String, pipelineId: String, formId: String, pluginName: String, pluginContentType: String): JSON
