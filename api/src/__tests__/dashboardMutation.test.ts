...
describe('Test dashboard mutations', () => {
  ...
  test('Create dashboard', async () => {
    ...
    const createdDashboard = await graphqlRequest(mutation, 'dashboardAdd', args);
  ...
  test('Create dashboard item', async () => {
    ...
    const createdDashboardItem = await graphqlRequest(mutation, 'dashboardItemAdd', args);
  ...
  test('Remove dashboard item', async () => {
    ...
    await graphqlRequest(mutation, 'dashboardItemRemove', { _id: dashboard._id });
