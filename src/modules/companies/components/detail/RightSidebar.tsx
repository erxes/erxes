    ...
    return (
      <Sidebar>
        <CustomerSection
          ...
          onSelect={cmrsChange}
        />
        <PortableDeals mainType="company" mainTypeIds={[company._id]} />
        <PortableTickets mainType="company" mainTypeIds={[company._id]} />
        <PortableTasks mainType="company" mainTypeIds={[company._id]} />
