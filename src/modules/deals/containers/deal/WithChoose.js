...
export default function WithChoose(WrappedComponent, params) {
  const WithChoose = class extends React.Component {
    constructor(props) {
      super(props);
  ...
  WithChoose.displayName = 'WithChooseComponent';

  WithChoose.propTypes = {
