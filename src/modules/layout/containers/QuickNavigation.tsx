...
import { AllUsersQueryResponse } from 'modules/settings/brands/types';
...
type Props = {
  brandsQuery: AllUsersQueryResponse;
  getEnvQuery: any;
};
...
export default withProps(
  compose(
    ...
    graphql<{}, AllUsersQueryResponse>(gql(brandQueries.allBrands), {
      name: 'brandsQuery',
      options: () => ({
        fetchPolicy: 'network-only'
      })
