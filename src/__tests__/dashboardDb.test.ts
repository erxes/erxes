...
describe('Brands db', () => {
  ...
  test('Update dashboard', async () => {
    const dashboardObjPrev = await Dashboards.addDashboard({ name: 'dashboard' });

    const updatedDashboard = await Dashboards.editDashboard(dashboardObjPrev._id, { name: 'updatedDashboard' });
  ...
  test('Update dashboard', async () => {
    ...
    const updatedDashboard = await DashboardItems.editDashboardItem(dashboardObjPrev._id, { name: 'updatedDashboard' });
