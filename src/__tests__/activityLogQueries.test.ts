...
describe("activityLogs", () => {
  ...
  test("customerActivityLog", async () => {
    ...
    expect(logs[0].list[3].content).toBe(
    ...
    expect(logs[yearMonthLength - 1].list[februaryLogLength].id).toBe(
      internalNote._id
    );
    expect(logs[yearMonthLength - 1].list[februaryLogLength].action).toBe(
      "internal_note-create"
    );
    expect(logs[yearMonthLength - 1].list[februaryLogLength].content).toBe(
      internalNote.content
    );

    expect(logs[yearMonthLength - 1].list[februaryLogLength - 1].id).toBe(
      _conversation._id
    );
    ...
    expect(logs[yearMonthLength - 1].list[februaryLogLength - 2].id).toBe(
      customer._id
    );
    expect(logs[yearMonthLength - 1].list[februaryLogLength - 2].action).toBe(
      "customer-create"
    );
