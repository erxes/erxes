...
- You should read the <a href="https://docs.erxes.io/" target="_blank">docs</a>.
- Make sure you set up a test project with erxes
...
- Afterwards, if you're contributing to our documentation about changes you made to the erxes codebase, make sure to also check out <a href="https://docs.erxes.io/" target="_blank">the contribution guidelines on our documentation website.</a>
