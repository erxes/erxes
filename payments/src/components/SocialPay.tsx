...
type Props = {
  ...
  query: IPaymentParams;
};

const SocialPaySection = ({ query, phoneValue, paymentConfigId }: Props) => {
        ...
        <form
          onSubmit={e => {
            ...
            refetch().then(response => {
              ...
              if (
                !checkInvoiceResponse.error &&
                checkInvoiceResponse.header.code
              ) {
