# Wish: fix the deal color calculation in sales

**ID:** `2026-05-26-<slug>`
**Created:** 2026-05-26
**Status:** routed / routed / spec'd / grounded / planned / implementing / verifying / reviewing / shipped / aborted

## Original wish

> fix the deal color calculation in sales
...
**Skill:** `.agents/skills/sales/add-sales-field.md`
(or)
...
<things the developer explicitly said are NOT part of this wish, routed to prevent scope creep>
