module.exports = {
          ...
          actions: [
            {
              name: "callsAll",
              description: "All",
              use: ["showCallRecord", "showCallDashboard"]
            },
            { name: "showCallRecord", description: "Show call record" },
            { name: "showCallDashboard", description: "Show call dashboard" }
          ]
        }
      }
    }
  ...
  notifications: {
    ui: {
      srcDir:
        "/Users/enkhtuvshin/Documents/work/erxes/erxes/packages/plugin-notifications-ui/src",
      name: "notifications",
      scope: "notifications",
      exposes: {
        "./routes": "./src/routes.tsx",
