...
import { IDonateCompaign, IDonateCompaingAward } from '../types';
import Select from 'react-select-plus';
import { __ } from 'erxes-ui';
import { IVoucherCompaign } from '../../voucherCompaign/types';
import { DonateCompaign } from '../../../../api/models/DonateCompaigns';
...
class Form extends React.Component<Props, State> {
  ...
  renderAward = (award: IDonateCompaingAward, formProps) => {
