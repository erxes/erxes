import { ImportHeaderDefinition, IImportExportContext } from 'erxes-api-shared/core-modules';
...
export async function getCompanyExportHeaders(
  ...
  return [
    ...
    { label: 'Size', key: 'size' },
    { label: 'Parent Company', key: 'parentCompanyId' },
    ...
    { label: 'Merged Companies', key: 'mergedIds' },
    { label: 'Code', key: 'code' },
