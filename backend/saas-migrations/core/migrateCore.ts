...
const UNIQUE_FIELDS: Record<string, string[]> = {
  ...
  structures: ['code'],
  departments: ['code', 'order'],
  units: ['code', 'order'],
  branches: ['code', 'order'],
  positions: ['code', 'order'],
  notification_settings: ['userId'],
  broadcast_delivery_reports: ['engageMessageId'],
  client_portals: ['token'],
  client_portal_users: ['username'],
