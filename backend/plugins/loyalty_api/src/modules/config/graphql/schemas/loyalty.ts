...
export const mutations = `
  ...
  cpShareScore(ownerType: String, ownerId: String, score: Float, destinationOwnerId: String, destinationPhone: String, destinationEmail: String, destinationCode: String): String
`;
