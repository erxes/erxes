...
import { LOTTERY_STATUS } from '~/modules/loyalty/@types/constants';
import { ILotteryDocument, ILottery } from '~/modules/loyalty/@types/lotteries';
import { lotterySchema } from '~/modules/loyalty/db/definitions/lotteries';
