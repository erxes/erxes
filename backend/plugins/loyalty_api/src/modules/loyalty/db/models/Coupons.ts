...
import { CHAR_SET, CODE_STATUS } from '~/modules/loyalty/@types/constants';
import { ICouponCampaignDocument } from '~/modules/loyalty/@types/couponCampaigns';
import {
  ICouponDocument,
  ICouponInput,
} from '~/modules/loyalty/@types/coupons';
import { couponSchema } from '~/modules/loyalty/db/definitions/coupons';
