...
import {
  CAMPAIGN_STATUS,
  LOTTERY_STATUS,
} from '~/modules/loyalty/@types/constants';
import { ILottery } from '~/modules/loyalty/@types/lotteries';
import {
  ILotteryCampaignDocument,
  ILotteryCampaign,
} from '~/modules/loyalty/@types/lotteryCampaigns';
import { lotteryCampaignSchema } from '~/modules/loyalty/db/definitions/lotteryCampaigns';
