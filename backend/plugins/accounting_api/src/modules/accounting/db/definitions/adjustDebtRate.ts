...
export const adjustDebtRateDetailsSchema = new Schema({
...
export const adjustDebtRatesSchema = new Schema({
  _id: mongooseStringRandomId,
  ...
  customerId: { type: String, optional: true, label: 'Customer' }, // харилцагч сонгосон бол харилцагчийн дансны үлдэгдлээр, Сонгоогүй бол харилцагч хамаарахгүй
