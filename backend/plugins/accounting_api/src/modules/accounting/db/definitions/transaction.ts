...
export const transactionSchema = schemaWrapper(
  new Schema({
    ...
    mentionOwnerId: { type: String, optional: true, label: 'Mention Owner', index: true },
    mentionUserIds: { type: [String], optional: true, label: 'Mention Users', index: true },
    ...
    createdBy: { type: String, label: 'Created user', index: true },
