...
| Call reporting       | `src/modules/reports/callReportService.ts`, `callStatistics.ts`            | CDR filter, leg-to-call folding, and the per-queue/agent/number report computation                      |
