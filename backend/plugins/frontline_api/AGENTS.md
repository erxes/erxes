...
| Comment ↔ mail       | `src/modules/integrations/mail/utils/{comments,tickets,thread,noteContent}.ts` | Mails an agent's comment from the pipeline address and turns an inbound reply back into a comment                                                                                                      |
