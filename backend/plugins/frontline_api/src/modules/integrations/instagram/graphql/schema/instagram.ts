...
const commonBotParams = `
  ...
  accountId:String,
  pageId:String,
  persistentMenus:[BotInstagramPersistentMenuInput],
  greetText:String
  tag:String,
...
export const types = `
  ...
  type BotInstagramPersistentMenuType {
    _id:String
    type:String
    text: String
    link: String
  ...
  input BotInstagramPersistentMenuInput {
    _id:String
    type:String
    text: String
    link: String
  ...
  type InstagramMessengerBot {
    ...
    page: JSON
    createdAt: Date
    persistentMenus:[BotInstagramPersistentMenuType]
    profileUrl:String
    greetText:String
    tag:String
    isEnabledBackBtn:Boolean
