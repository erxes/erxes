  ...
  modules: [
    {
      ...
      actions: [
        ...
        // dealsCopy reuses dealsAdd – no separate action needed
      ],
    },

    {
      ...
      scopes: [
        { name: 'all', description: 'All boards' },
      ],
...

    {
      ...
      scopes: [
        { name: 'all', description: 'All pipelines' },
      ],
...

    {
      ...
      scopes: [
        { name: 'all', description: 'All stages' },
      ],
...

    {
      ...
      scopes: [
        { name: 'all', description: 'All checklists' },
      ],
...

    {
      ...
      scopes: [
        { name: 'all', description: 'All pipeline labels' },
      ],
...

    {
      ...
      scopes: [
        { name: 'all', description: 'All pipeline templates' },
      ],
      ...
      permissions: [
        {
          plugin: 'sales',
          module: 'deal',
          actions: ['showDeals', 'dealsAdd', 'dealsEdit', 'dealsRemove', 'dealsWatch', 'dealsArchive'],
          scope: 'all',
        },
        {
          plugin: 'sales',
          module: 'board',
          actions: ['boardsAdd', 'boardsEdit', 'boardsRemove', 'updateTimeTracking'],
          scope: 'all',
        },
        {
          plugin: 'sales',
        ...
        },
        {
          ...
          actions: ['pipelineLabelsAdd', 'pipelineLabelsEdit', 'pipelineLabelsRemove'],
          scope: 'all',
        },
        {
          plugin: 'sales',
          module: 'pipelineTemplate',
          actions: ['showTemplates', 'templatesAdd', 'templatesEdit', 'templatesRemove'],
          scope: 'all',
        },
      ],
    },
