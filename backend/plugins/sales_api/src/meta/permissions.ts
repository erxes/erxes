  ...
  modules: [
    {
      ...
      actions: [
        ...
        },
        {
          title: 'Watch deals',
          name: 'dealsWatch',
          description: 'Watch deals',
        },
        {
          title: 'Archive deals',
          name: 'dealsArchive',
          description: 'Archive / unarchive deals',
        },
      ],
    },
    {
      ...
      actions: [
        ...
        {
          title: 'Update time tracking',
          name: 'updateTimeTracking',
          description: 'Update time tracking on board items',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      actions: [
        ...
        {
          title: 'Sort items in stage',
          name: 'itemsSort',
          description: 'Sort items in a stage',
        },
      ],
    },
    {
      ...
      actions: [
        ...
        },
        {
          ...
          name: 'checklistsEdit',
          description: 'Edit checklists (includes item changes)',
        },
        {
          title: 'Remove checklists',
          name: 'checklistsRemove',
          description: 'Remove checklists',
        },
      ],
    },
    {
      ...
      actions: [
        {
          title: 'Add pipeline labels',
          name: 'pipelineLabelsAdd',
          description: 'Create pipeline labels',
        },
        {
          title: 'Edit pipeline labels',
          name: 'pipelineLabelsEdit',
          description: 'Edit pipeline labels',
        },
        {
          title: 'Remove pipeline labels',
          name: 'pipelineLabelsRemove',
          description: 'Remove pipeline labels',
        },
      ],
    },
    {
      ...
      actions: [
        {
          ...
          name: 'showTemplates',
          description: 'View pipeline templates',
          always: true,
        },
        {
          title: 'Add templates',
    ...
    },
    {
      ...
      actions: [
        // Read actions (queries)
        {
          ...
          name: 'posRead',
          description: 'View POS configuration',
          always: true,
        },
        {
          title: 'View orders',
        ...
        {
          title: 'Change order payments',
          name: 'posOrderChangePayments',
          description: 'Modify order payments',
        },
        {
          title: 'Manage product groups',
          name: 'productGroupsBulkInsert',
          description: 'Bulk update product groups',
        },
        {
          title: 'Manage slots',
          name: 'posSlotBulkUpdate',
          description: 'Bulk update POS slots',
        },
        {
          title: 'Edit covers',
          name: 'posCoversEdit',
          description: 'Edit POS covers',
        },
        {
          title: 'Remove covers',
          name: 'posCoversRemove',
          description: 'Remove POS covers',
        },
        {
          title: 'Export POS items',
          name: 'posItemsExportManage',
          description: 'Export POS items',
        },
      ],
    },
  ],
  ...
  defaultGroups: [
    {
      ...
      permissions: [
        ...
        },
        {
          plugin: 'sales',
          module: 'pipeline',
          actions: ['pipelinesAdd', 'pipelinesEdit', 'pipelinesWatch'],
          scope: 'all',
        },
        {
          plugin: 'sales',
          module: 'stage',
          actions: ['stagesEdit', 'stagesRemove', 'itemsSort'],
          scope: 'all',
        },
        {
          plugin: 'sales',
          module: 'checklist',
          actions: ['checklistsAdd', 'checklistsEdit', 'checklistsRemove'],
          scope: 'all',
        },
        {
          plugin: 'sales',
    ...
    },
    {
      ...
      permissions: [
        ...
        },
        {
          plugin: 'sales',
          module: 'checklist',
          actions: ['checklistsAdd', 'checklistsEdit'],
          scope: 'all',
        },
        {
          plugin: 'sales',
          module: 'pipeline',
          actions: ['pipelinesWatch'],
          scope: 'all',
        },
        {
          plugin: 'sales',
          module: 'pos',
          actions: ['posRead', 'posOrderRead', 'posCoversRead'],
          scope: 'group',
        },
      ],
    },
