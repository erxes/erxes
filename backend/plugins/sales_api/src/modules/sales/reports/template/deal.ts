...
export const dealCharts = [
  ...
  },
  {
    ...
    getChartResult: async (
      ...
      const totalCountByLabel = (deals || []).reduce(
        (acc, { count, label }) => {
          acc[label] = count;
          return acc;
        },
  ...
  },
  {
    ...
    getChartResult: async (
      ...
      const totalCountByCustomProperties = (deals || []).reduce(
        (acc, { count, field }) => {
          acc[field] = count;
          return acc;
        },
  ...
  },
  {
    ...
    getChartResult: async (
      ...
      const averageAmountByRep = (deals || []).reduce(
        (acc, { user, averageAmount }) => {
          if (user) {
  ...
  },
  {
    ...
    getChartResult: async (
      ...
      const dealsRevenueByStage = (deals || []).reduce(
  ...
  },
  {
    ...
    getChartResult: async (
      ...
      const totalCountAndAmountByFrequency = (deals || []).reduce(
        (acc, { count, _id }) => {
          acc[_id] = count;
          return acc;
        },
  ...
  },
  {
    ...
    getChartResult: async (
      ...
      const pipeline = await buildPipeline(filter, "deal", matchFilter);
    ...
    filterTypes: [
      ...
      // CAR CATEGORY FILTER
      {
        fieldName: "carCategoryIds",
        fieldType: "select",
        fieldQuery: "carCategories",
        fieldValueVariable: "_id",
        fieldLabelVariable: "name",
        multi: true,
        searchable: true,
        fieldLabel: "Select car category",
      },
      // CAR FILTER
      {
        fieldName: "carIds",
        ...
        fieldQuery: "carsMain",
        fieldValueVariable: "_id",
        fieldLabelVariable: "plateNumber",
        fieldInitialVariable: "list",
        multi: true,
        searchable: true,
      ...
      },
      {
        ...
        fieldType: "input",
        fieldAttributes: [
          { name: "target", type: "number", min: 0, placeholder: "Target" },
        ],
        fieldLabel: "Target",
      },
      // DATE RANGE TYPE FILTER
  ...
  },
  {
    ...
    getChartResult: async (
      ...
      const { dateRangeType = "closeDate", frequencyType = "%Y-%m-%d" } =
        filter;
      const matchFilter = await buildMatchFilter(
        filter,
        "deal",
  ...
  },
  {
    ...
    getChartResult: async (
      ...
      const totalCountByStage = (deals || []).reduce(
