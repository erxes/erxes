...
import { IConfigDocument } from '@/posclient/@types/configs';
import { IPosUserDocument, IPosUser } from '@/posclient/@types/posUsers';
import { posUserSchema } from '@/posclient/db/definitions/posUsers';
