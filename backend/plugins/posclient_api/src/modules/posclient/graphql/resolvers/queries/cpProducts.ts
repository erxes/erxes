...
const cpProductQueries: Record<string, Resolver> = {
  ...
  async cpPoscProductsTotalCount(
    _root,
    params: IProductParams,
  ...
  async cpPoscProductSimilarities(
    _root,
    {
      _id,
      groupedSimilarity,
  ...
  async cpPoscProductCategoriesTotalCount(
    _root,
    {
      parentId,
      withChild,
  ...
  async cpPoscProductCategoryDetail(
    _root,
    { _id }: { _id: string },
    { models }: IContext,
  ) {
...
export default cpProductQueries;
