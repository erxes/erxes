...
/******/ 	return __webpack_require__(__webpack_require__.s = "./client/form/widget/index.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./client/form/widget/index.css":
/*!**************************************!*\
  !*** ./client/form/widget/index.css ***!
  \**************************************/
...
// load the styles
var content = __webpack_require__(/*! !../../../node_modules/css-loader!./index.css */ "./node_modules/css-loader/index.js!./client/form/widget/index.css");
...
Object.defineProperty(exports, "__esModule", { value: true });
// css
__webpack_require__(/*! ./index.css */ "./client/form/widget/index.css");
...
var createIframe = function (setting) {
    var formId = setting.form_id;
    // container
    var containerId = "erxes-container-" + formId;
    var iframeId = "erxes-iframe-" + formId;
    ...
    iframe.src = widgetUtils_1.generateIntegrationUrl('form');
    container.appendChild(iframe);
    // if there is an placeholder for embed then add new iframe to it
    var embedContainer = document.querySelector("[data-erxes-embed=\"" + formId + "\"]");
    if (embedContainer) {
    ...
    iframe.onload = function () {
        ...
        var handlerSelector = "[data-erxes-modal=\"" + setting.form_id + "\"]";
        var contentWindow = iframe.contentWindow;
        if (!contentWindow) {
            return;
        }
        var modifiedSetting = __assign({}, setting);
...
var postMessageToOne = function (formId, data) {
    var settingAsString = Object.keys(iframesMapping).find(function (sas) {
        var setting = JSON.parse(sas);
        return formId === setting.form_id;
    });
    if (!settingAsString) {
        return;
    }
    var iframe = iframesMapping[settingAsString].iframe;
    var contentWindow = iframe.contentWindow;
    if (!contentWindow) {
        return;
    }
    contentWindow.postMessage(__assign({ fromPublisher: true, formId: formId }, data), '*');
};
widgetUtils_1.setErxesProperty('showPopup', function (id) {
    postMessageToOne(id, { action: 'showPopup' });
});
widgetUtils_1.setErxesProperty('callFormSubmit', function (id) {
    postMessageToOne(id, { action: 'callSubmit' });
});
widgetUtils_1.setErxesProperty('sendExtraFormContent', function (id, html) {
    postMessageToOne(id, { action: 'extraFormContent', html: html });
});
var formSettings = window.erxesSettings.forms || [];
// create iframes and save with index
var iframesMapping = {};
var getMappingKey = function (setting) {
    return JSON.stringify({ form_id: setting.form_id, brand_id: setting.brand_id });
};
var getSetting = function (setting) {
    return formSettings.find(function (s) {
        return s.brand_id === setting.brand_id && s.form_id === setting.form_id;
    });
};
formSettings.forEach(function (formSetting) {
...
window.addEventListener('message', function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var data, fromErxes, source, message, setting, _a, container, iframe, completeSetting, loadType, selector, elements, i, elm;
    return __generator(this, function (_b) {
        data = event.data || {};
        fromErxes = data.fromErxes, source = data.source, message = data.message, setting = data.setting;
        if (!setting) {
            return [2 /*return*/, null];
        }
        _a = iframesMapping[getMappingKey(setting)], container = _a.container, iframe = _a.iframe;
        widgetUtils_1.listenForCommonRequests(event, iframe);
        completeSetting = getSetting(setting);
        if (!completeSetting) {
            return [2 /*return*/, null];
        }
        ...
        if (message === 'connected') {
            loadType = data.connectionInfo.widgetsLeadConnect.integration.leadData.loadType;
            // track popup handlers
            if (loadType === 'popup') {
                selector = "[data-erxes-modal=\"" + setting.form_id + "\"]";
...
/***/ "./node_modules/css-loader/index.js!./client/form/widget/index.css":
/*!****************************************************************!*\
  !*** ./node_modules/css-loader!./client/form/widget/index.css ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
