...
:::info Ubuntu 20.04
The three installation guides are for installing erxes on **Ubuntu 20.04**. They should work on any hosting provider that allows you to install Ubuntu 20.04.
...
Please install **erxes** with either the [Quick Start](ubuntu-quickstart.mdx), [Step by Step](ubuntu-step-by-step.mdx), and [Docker based installation](docker.md) instruction guides.
