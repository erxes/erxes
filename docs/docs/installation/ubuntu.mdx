...
The first guide is the **Quick Start** installation guide where we provide a script that automates most of the installation process. The second guide is a comprehensive, **Step by Step** guide where advanced developers can see exactly what is being installed and how.
...
- Choose a server size that corresponds with the requirements for installing with **Quickstart** or **Step by Step** instructions.
- The server should install with **Ubuntu 18.04**.
