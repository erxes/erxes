...
server {
        ...
        # erxes build path
        root /home/erxes/erxes.io/erxes/erxes;
        index index.html;
  ...
  apps: [
    {
      name: 'erxes-api',
      script: 'dist',
      cwd: '/home/erxes/erxes.io/erxes-api/erxes-api',
    ...
    },
    {
      name: 'erxes-widgets',
      script: 'dist',
      cwd: '/home/erxes/erxes.io/erxes/erxes-widgets',
      log_date_format: 'YYYY-MM-DD HH:mm Z',
      node_args: '--max_old_space_size=4096',
      env: {
        PORT: 3200,
    ...
    },
    {
      name: 'erxes-engages',
      script: 'dist',
      cwd: '/home/erxes/erxes.io/erxes-api/erxes-engages-email-sender',
      log_date_format: 'YYYY-MM-DD HH:mm Z',
      node_args: '--max_old_space_size=4096',
      env: {
        PORT: 3900,
    ...
    },
    {
      name: 'erxes-logger',
      script: 'dist',
      cwd: '/home/erxes/erxes.io/erxes-api/erxes-logger',
      log_date_format: 'YYYY-MM-DD HH:mm Z',
      node_args: '--max_old_space_size=4096',
      env: {
        PORT: 3800,
    ...
    },
    {
      ...
      script: 'dist',
      cwd: '/home/erxes/erxes.io/erxes-integrations/erxes-integrations',
      log_date_format: 'YYYY-MM-DD HH:mm Z',
      node_args: '--max_old_space_size=4096',
      env: {
        PORT: 3400,
    ...
    },
    {
      ...
      script: 'main.py',
      cwd: '/home/erxes/erxes.io/erxes-api/erxes-elkSyncer',
      log_date_format: 'YYYY-MM-DD HH:mm Z',
    ...
    },
    {
      ...
      script: 'dist',
      cwd: '/home/erxes/erxes.io/erxes-api/erxes-email-verifier',
      log_date_format: 'YYYY-MM-DD HH:mm Z',
      node_args: '--max_old_space_size=4096',
      env: {
        PORT_WORKERS: 3700,
...
```bash
nano ~/erxes.io/erxes/erxes/js/env.js
```
