...
Unless you are using a server with 4GB RAM or higher, you **must use** Option **2 Use elasticsearch.erxes.io** which is the second option of using the erxes hosted version. If you do not, your installation will fail.
