...
You will have two options, **1 Install ElasticSearch** or **2 Use elasticsearch.erxes.io**. We recommend the first option, and install it on your own server but if you encounter difficulties, to choose the second option of using the erxes hosted version.
...
You have installed **erxes**. You may now visit your url, and log in.
