...
to intsall the card plugin after installing the erxes XOS.
...
To customize your Task Management cards, you can create additional fields that fit your unique needs from each card. To add new properties in your Task pipeline card, you’ll need to go to the Property plugin <a href="https://docs.erxes.io/docs/plugin-tutorials/core-plugins/property">**here.**</a>
