...
function Cards() {
  return (
    <>
      <div className={styles.styled}>
        <NameCard
          user={{ details: { fullName: "Ariunzaya Enkhbayar" } }}
        ></NameCard>
      </div>
      <CodeBlock className="language-jsx">{`<>
  ...
  return (
    <>
      <div className={styles.styled}>
        <NameCard
          user={{
            details: { fullName: "Ariunzaya Enkhbayar" },
            email: "ariunzaya@gmail.com",
          }}
        ></NameCard>
      </div>
      <CodeBlock className="language-jsx">{`<>
      ...
      <Table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>string</td>
            <td>
              Fullname object of user. If you have details and username, it will
              only show detail
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>string</td>
            <td>
              Line below the username or full name.You can write anything in the
              second line
            </td>
          </tr>
          <tr>
