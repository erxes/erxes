...
import Header from "erxes-ui/lib/layout/components/Header";

export function FilterComponent() {
    // let stts="";
    // const queryParams={status: stts};
    // console.log("stts",stts);
return (<>
    <Filter queryParams={{startDate:"2021/12/01", endDate:"2021/12/12", awaitingResponse:"bh"}} />
    {/* <Filter queryParams={{tag: [{type: "tag", _id: "1", name:"tag1name", tagDetail: "tag1"}, {type: "tag", _id: "2", name:"tag2name", tagDetail: "tag2"}]}} /> */}
