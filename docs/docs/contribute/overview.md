...
If you’re interested in contributing to erxes codebase, check out the <a href="https://www.erxes.org/contribute/contribute-to-codebase" target="_blank">guideline to contribute codebase</a>. Then, you can edit or re-write the documentation on the part you have contributed by following <a href="https://www.erxes.org/contribute/contribute-to-documentation" target="_blank">the guideline to contribute to documentation</a>. 
