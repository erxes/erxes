      ...
      >
        <div className="container">
          <div className={styles.header}>
            <h1 className={styles.headingOne}>Developer Partner</h1>
            <p className={styles.description}>
              Interested in using erxes for your clients? Start by becoming a
              Developer Partner. It’s a low-cost and low-commitment way to see
              what a partnership with us could do for your business. And with a
              low monthly cost and monthly billing, you can stop when you want.
            </p>
