...
const MessageProComponents: AutomationComponentMap<AutomationNodeType.Action> = {
  messagePro: {
    sidebar: lazy(() =>
      import(
        '@/automations/components/builder/nodes/actions/messagePro/components/MessageProConfigForm'
      ).then((module) => ({
    ...
    nodeContent: lazy(() =>
      import(
        '@/automations/components/builder/nodes/actions/messagePro/components/MessageProNodeContent'
      ).then((module) => ({
