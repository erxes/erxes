...
import {
  LogDetailProvider,
  useLogDetailContext,
} from '@/logs/providers/LogDetailProvider';
...
const LogDetailContent = () => {
  const { detail } = useLogDetailContext();
  ...
  return (
    <Suspense fallback={<LogLoading message="Loading content..." />}>
