    ...
    common: [
      {
        ...
        description: t(
          'email-desc',
          'Set an email address you wish to send your internal transactional emails from (e.g. task notifications, team member mentions).',
        ),
      },
      {
      ...
      },
      {
        ...
        description: t(
          'temp-desc',
          'Your email will be sent with erxes email template.',
        ),
      },
      {
