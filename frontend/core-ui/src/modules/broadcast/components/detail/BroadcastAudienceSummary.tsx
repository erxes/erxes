...
import { TBroadcastAudienceItem, TBroadcastMessage } from '../../types';
...
export const BroadcastAudienceSummary = ({
  message,
}: {
  ...
  const { targetType, segments = [], customerTags = [] } = message;
  ...
  const list: TBroadcastAudienceItem[] = isTag ? customerTags : segments;
