  ...
  return (
    <DateInputRac
      className={composeRenderProps(className, (className) =>
        cn(
          !unstyled &&
            'relative inline-flex h-7 w-full items-center overflow-hidden whitespace-nowrap rounded bg-background px-2 py-2 text-sm shadow-xs transition-[color,box-shadow] outline-hidden data-[focus-within=true]:shadow-focus data-[focus-within=true]:has-aria-invalid:shadow-destructive',
          className,
        ),
      )}
      {...props}
