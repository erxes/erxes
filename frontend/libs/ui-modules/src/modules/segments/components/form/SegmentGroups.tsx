          ...
          <div key={id} className="relative">
            {total > 1 && (
              <div className="absolute left-0 flex items-center h-full">
                {/* Vertical line */}
                {!isFirst && (
                  <div className="absolute top-0 left-[24px] w-px h-1/2 bg-gray-300"></div>
                )}
                {!isLast && (
                  <div className="absolute bottom-0 left-[24px] w-px h-1/2 bg-gray-300"></div>
                )}

                {/* Horizontal line */}
                <div className="absolute left-[24px] w-[20px] h-px bg-gray-300"></div>
