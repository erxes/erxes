...
export const firstDonateColumns = (t: TFunction): ColumnDef<IDonate>[] => [
  {
    id: 'createdAt',
...
export const secondDonateColumns = (t: TFunction): ColumnDef<IDonate>[] => [
  {
    id: 'ownerId',
    accessorKey: 'ownerId',
...
export const donateColumns = (t: TFunction): ColumnDef<IDonate>[] => [
