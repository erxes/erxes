...
import {
  ...
  DateSelectProvider,
  DateSelectVariant,
} from '../selects/SelectAssignmentDate';
import { format } from 'date-fns';
import { IconCalendarPlus, IconCalendarTime } from '@tabler/icons-react';

interface AssignmentAddCampaignMoreFieldsProps {
...
export const AssignmentAddCampaignMoreFields: React.FC<
  AssignmentAddCampaignMoreFieldsProps
> = ({ form }) => {
  return (
