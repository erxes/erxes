...
import { Button, Label, Input, Badge, ScrollArea } from 'erxes-ui';
    ...
    <ScrollArea className="h-full">
      <div className="p-6 max-w-xl space-y-8">
        ...
        <div className="rounded-lg border p-4 space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            Controlled by the <code>MASTRA_MEMORY</code> environment variable.
            Set <code>MASTRA_MEMORY=enable</code> and restart the plugin to turn
            it on.
          </p>
        </div>
