...
import { erxesMessengerSetupConfigAtom, erxesMessengerSetupIntroAtom } from '../states/erxesMessengerSetupStates';
...
export const EMPreviewChatInput = () => {
  ...
  return (
    <div className="flex items-center gap-2 p-4">
      <Input placeholder={intro?.welcome || 'Send message'} className="flex-1 shadow-2xs" />
