  ...
  return (
    <IgMessageWrapper>
      <div className={cn('max-w-[428px]')} key={_id}>
        {content !== HAS_ATTACHMENT ? (
          <Button
            ...
            className={cn(
              ...
              internal && 'bg-info/20 hover:bg-info/5',
        ...
        <IgAttachments attachments={attachments} />
      </div>
    </IgMessageWrapper>
  );
};
...
const IgAttachment = ({ attachment }: { attachment: IAttachment }) => {
  return (
    <img
