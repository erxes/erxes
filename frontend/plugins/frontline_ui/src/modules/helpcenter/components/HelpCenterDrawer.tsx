...
import { HelpCenterAppearanceTab } from '@/helpcenter/components/HelpCenterAppearanceTab';
import { HelpCenterEmbedScriptDialog } from '@/helpcenter/components/HelpCenterEmbedScriptDialog';
import { HelpCenterGeneralTab } from '@/helpcenter/components/HelpCenterGeneralTab';
import {
  EMPTY_TOPIC_FORM,
  EMPTY_TOPIC_STYLES,
  FIELD_TAB,
} from '@/helpcenter/constants/helpCenterDrawerConstants';
import {
  Topic,
  TopicFormData,
  TopicStyles,
...
import { ADD_TOPIC, EDIT_TOPIC } from '@/knowledgebase/graphql/mutations';
import { TOPICS } from '@/knowledgebase/graphql/queries';
