...
// import { SelectMilestone } from './ticket-selects/SelectMilestone';
...
//   return (
//     <>
//       <Filter.Popover scope={TicketHotKeyScope.TicketsPage}>
...
//             </Command>
//           </Filter.View>
//           <SelectAssigneeTicket.FilterView teamIds={[teamId || '']} />
//           {!teamId && <SelectTeam.FilterView />}
//           <SelectPriority.FilterView />
//           {teamId ? (
//             <SelectStatusTicket.FilterView teamId={teamId} />
//           ) : (
...
//   return (
//     <Filter id="Tickets-filter" sessionKey={TASKS_CURSOR_SESSION_KEY}>
//       <Filter.Bar>
//         {searchValue && (
...
//               teamId={teamId}
//               scope={clsx(TicketHotKeyScope.TicketsPage, 'filter', 'Status')}
//             />
//           ) : (
