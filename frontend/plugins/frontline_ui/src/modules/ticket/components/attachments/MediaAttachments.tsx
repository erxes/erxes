      ...
      <div className="relative">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <Dialog.Content className="bg-transparent max-w-fit shadow-none border-0">
            <button
              className="absolute top-4 right-4 bg-background p-1 rounded-full z-50"
            ...
            <button
              className="absolute left-4 top-1/2 -translate-y-1/2 bg-background p-1 rounded-full z-50"
              onClick={() =>
                setCurrentIndex(
                  currentIndex === 0
            ...
            <button
              className="absolute right-4 top-1/2 -translate-y-1/2 bg-background p-1 rounded-full z-50"
              onClick={() =>
