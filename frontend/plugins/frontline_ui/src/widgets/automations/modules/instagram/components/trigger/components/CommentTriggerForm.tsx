...
import { InstagramBotSelector } from '~/widgets/automations/modules/instagram/components/MessengerBotSelector';
import { DirectMessageConfigForm } from '~/widgets/automations/modules/instagram/components/trigger/components/DirectMessageConfigForm';
