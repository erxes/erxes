...
import { InstagramMessageContent } from '~/widgets/automations/modules/instagram/components/action/components/replyMessage/InstagramMessageContent';

export const InstagramBotMessage = ({
  index,
  message,
  onRemove,
  handleMessageChange,
