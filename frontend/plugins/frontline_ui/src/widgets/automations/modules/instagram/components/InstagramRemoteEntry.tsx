import {
  ...
  import { AutomationHistoryName } from '~/widgets/automations/modules/instagram/components/AutomationHistoryName';
  import { AutomationHistoryResult } from '~/widgets/automations/modules/instagram/components/AutomationHistoryResult';
