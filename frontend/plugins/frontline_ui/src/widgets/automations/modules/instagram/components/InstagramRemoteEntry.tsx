...
import { InstagramAutomationHistoryName as AutomationHistoryName } from '~/widgets/automations/modules/instagram/components/AutomationHistoryName';
import { InstagramAutomationHistoryResult as AutomationHistoryResult } from '~/widgets/automations/modules/instagram/components/AutomationHistoryResult';
import { CommentTriggerForm } from '~/widgets/automations/modules/instagram/components/trigger/components/CommentTriggerForm';
import { CommentActionForm } from '~/widgets/automations/modules/instagram/components/action/components/replyComment/CommentActionForm';
import { ActionCommentConfigContent } from '~/widgets/automations/modules/instagram/components/action/components/replyComment/ActionCommentConfigContent';

export const InstagramRemoteEntry = (props: AutomationRemoteEntryProps) => {
  return (
    <AutomationRemoteEntryWrapper
      props={props}
      remoteEntries={{
