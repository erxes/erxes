...
const BulkDelete = ({
  ...
  rows: Row<TReturnErkhetConfigRow>[];
  onDeleteMany: (ids: string[]) => Promise<void>;
  loading: boolean;
}) => {
...
export const ReturnErkhetConfigCommandBar = ({ onDeleteMany, loading }: Props) => {
  const { table } = RecordTable.useRecordTable();
  const selectedRows = table.getFilteredSelectedRowModel().rows as Row<TReturnErkhetConfigRow>[];
