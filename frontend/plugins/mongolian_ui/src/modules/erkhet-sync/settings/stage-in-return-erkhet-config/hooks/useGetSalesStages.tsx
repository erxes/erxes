...
import { GET_SALES_STAGE } from '@/erkhet-sync/settings/stage-in-return-erkhet-config/graphql/queries/salesStages';
import { IStage } from '@/erkhet-sync/settings/stage-in-return-erkhet-config/types/stage';
