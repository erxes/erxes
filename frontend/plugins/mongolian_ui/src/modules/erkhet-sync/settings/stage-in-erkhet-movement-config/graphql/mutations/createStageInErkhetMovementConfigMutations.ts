...
export const CREATE_STAGE_IN_MOVEMENT_ERKHET_CONFIG = gql`
...
export const UPDATE_STAGE_IN_MOVEMENT_ERKHET_CONFIG = gql`
...
export const REMOVE_STAGE_IN_MOVEMENT_ERKHET_CONFIG = gql`
