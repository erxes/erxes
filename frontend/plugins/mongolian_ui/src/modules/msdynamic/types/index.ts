...
export const createEmptyMSDynamicConfig = (): IMSDynamicConfig => ({
  ...
  defaultUserCode: '',
  defaultCompanyCode: '',
  custCode: { contentType: '', fieldId: '' },
  userLocationCode: { contentType: '', fieldId: '' },
  useBoard: false,
  boardId: '',
  pipelineId: '',
  stageId: '',
...
export const toMSDynamicFormValues = (
  ...
  custCode: row.custCode ?? { contentType: '', fieldId: '' },
  userLocationCode: row.userLocationCode ?? { contentType: '', fieldId: '' },
