...
export const getMsDynamicConfigColumns = (
  ...
  RecordTable.checkboxColumn as ColumnDef<MSMDynamicConfigRow>,
  {
    id: 'title',
    accessorKey: 'title',
    header: () => <RecordTable.InlineHead icon={IconSettings} label={t('title', 'Title')} />,
  ...
  },
  {
    id: 'boardId',
    accessorKey: 'boardId',
    header: () => <RecordTable.InlineHead icon={IconBuildingStore} label={t('board', 'Board')} />,
  ...
  },
  {
    ...
    header: () => <RecordTable.InlineHead icon={IconSitemap} label={t('pipeline', 'Pipeline')} />,
  ...
  },
  {
    id: 'stageId',
    accessorKey: 'stageId',
    header: () => <RecordTable.InlineHead icon={IconSitemap} label={t('stage', 'Stage')} />,
