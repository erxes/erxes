...
import { putResponseQueries } from '~/modules/ebarimt/put-response/graphql/PutResopnseQueries';
import { putResponseRemoveMutation } from '~/modules/ebarimt/put-response/detail/graphql/mutations/PutResponseRemoveMutations';
