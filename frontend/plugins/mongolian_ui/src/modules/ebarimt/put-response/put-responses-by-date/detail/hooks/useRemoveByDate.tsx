...
import { byDateRemoveMutation } from '~/modules/ebarimt/put-response/put-responses-by-date/detail/graphql/mutations/ByDateRemoveMutations';
import { IByDate } from '~/modules/ebarimt/put-response/put-responses-by-date/types/ByDateType';
import { byDateQueries } from '~/modules/ebarimt/put-response/put-responses-by-date/graphql/ByDateQueries';
