...
import { GET_SALES_PIPELINES } from '@/ebarimt/settings/stage-in-return-ebarimt-config/graphql/queries/salesPipelines';
import { IPipeline } from '@/ebarimt/settings/stage-in-return-ebarimt-config/types/pipeline';
