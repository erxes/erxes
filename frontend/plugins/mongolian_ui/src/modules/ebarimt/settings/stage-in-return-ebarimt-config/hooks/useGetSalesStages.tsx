...
import { GET_SALES_STAGE } from '@/ebarimt/settings/stage-in-return-ebarimt-config/graphql/queries/salesStages';
import { IStage } from '@/ebarimt/settings/stage-in-return-ebarimt-config/types/stage';
