...
> = {
  ...
  ctax: {
    ...
    options: [
      {
        value: '0',
        label: '0024-Жижиглэн худалдаалсан бүх төрлийн архи согтууруудах ундаа',
      },
      {
        value: '1',
        label: '0025-Жижиглэн худалдаагаар борлуулсан бүх төрлийн тамхи',
      },
