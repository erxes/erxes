...
export function PageDrawer({
  ...
  const appliedForPageRef = useRef<any>(null);
  useEffect(() => {
    if (
      !selectedLanguage ||
      !defaultLanguage ||
  ...
  const onLanguageChange = (lang: string) => {
    ...
    // the Editor (which remounts on selectedLanguage key change) reads the
    // correct initialContent.  handleLanguageChange's setFormData may use
