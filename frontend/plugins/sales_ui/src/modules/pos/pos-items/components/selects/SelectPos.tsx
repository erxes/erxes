...
import { IPos } from '@/pos/pos-items/types/pos';
import {
  SelectPosContext,
  useSelectPosContext,
} from '@/pos/pos-items/context/SelectPosContext';
import { usePos } from '@/pos/pos-items/hooks/useSelectPos';
import { PosInline } from '@/pos/pos-items/components/PosInline';
  ...
  return (
    <Command shouldFilter={false} id="pos-command-menu">
      ...
      <Command.List>
        ...
        {posList
          .filter((pos: IPos) =>
            selectedPos.every((b: IPos) => b._id !== pos._id),
          )
          .map((pos: IPos) => (
            <SelectPosCommandItem key={pos._id} pos={pos} />
          ))}
