...
import { useIsPosItemsLeadSessionKey } from '../hooks/UsePosItemsLeadSessionKey';
import { PosItemsTotalCount } from './PosItemsToTalCount';
import { PosItemsHotKeyScope } from '../types/posItemsHotKeyScope';
...
export const PosFilter = () => {
  ...
  const { sessionKey } = useIsPosItemsLeadSessionKey();
