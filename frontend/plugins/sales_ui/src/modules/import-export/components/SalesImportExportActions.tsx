...
export const SalesImport = ({
  ...
  const inputId = useId();
  const contentType = getContentType({ pluginName, moduleName, collectionName });
  const {
    activeImports,
    isDragOver,
    handleDragOver,
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Download the template, add your {pluralLabel}, then upload
                  the file to create or update {pluralLabel} in bulk.
                </p>
                {renderAdditionInfo()}
              </div>
            </div>
                      ...
                      <div className="rounded-xl border bg-muted/20 px-4 py-3">
                        ...
                        <div className="mt-2 divide-y">
                          <StepRow
                            ...
                            description={`Start with the template so your ${pluralLabel} columns match the importer.`}
                          />
                          <StepRow
                            icon={IconFileSpreadsheet}
                            title={`Add your ${pluralLabel}`}
