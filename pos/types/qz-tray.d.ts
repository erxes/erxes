declare module "qz-tray" {
  ...
  interface QzConfigs {
    ...
    create(printer: string | Record<string, unknown>, options?: Record<string, unknown>): PrintConfig
  }

  interface QzApi {
    setPromiseType(promiser: (resolver: (...args: unknown[]) => void) => Promise<unknown>): void
