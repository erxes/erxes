...
class WithStages extends Component<WithStagesProps> {
  render() {
    ...
    let groupType = "stage";
    let groups: any[] = stagesQuery.purchasesStages || [];

    if (queryParams.groupBy === "label") {
      groups = pipelineLabelsQuery.purchasesPipelineLabels || [];
      groupType = "label";
    }
    ...
    if (queryParams.groupBy === "assignee") {
      groups = pipelineAssigneeQuery.purchasesPipelineAssignedUsers || [];
      groupType = "assignee";
    }
