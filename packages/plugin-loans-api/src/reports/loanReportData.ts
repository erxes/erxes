...
const MEASURE_OPTIONS = [
  ...
  },
  {
    label: 'Total Amount',
    value: 'totalAmount',
    aggregate: { path: 'totalAmount', value: 1 },
    format: (v: number = 0) => new BigNumber(v).toFormat()
  },
  {
    label: 'Given Amount',
    value: 'givenAmount',
    aggregate: { path: 'givenAmount', value: 1 },
    format: (v: number = 0) => new BigNumber(v).toFormat()
  },
  {
  ...
  },
  {
    label: 'FeeAmount',
    value: 'feeAmount',
    aggregate: { path: 'feeAmount', value: 1 },
    format: (v: number = 0) => new BigNumber(v).toFormat()
  }
];
