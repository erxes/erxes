...
import {
  ...
  AccountingsConfigsQueryResponse,
  UomsQueryResponse,
...
const ProductFormContainer = (props: FinalProps) => {
  const { productCategoriesQuery, accountingsConfigsQuery, uomsQuery } = props;

  if (productCategoriesQuery.loading || accountingsConfigsQuery.loading) {
    return null;
  }
