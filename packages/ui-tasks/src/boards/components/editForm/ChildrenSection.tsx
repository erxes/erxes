...
import { AddForm } from '@erxes/ui-tasks/src/boards/containers/portable';
import EditForm from '@erxes/ui-tasks/src/boards/containers/editForm/EditForm';
import { IOptions } from '../../types';
import { __ } from '@erxes/ui/src/utils';
import { ITask } from '../../../tasks/types';
import { SectionBodyItem } from '@erxes/ui/src/layout/styles';
import { ProductName } from '../../../tasks/styles';
  ...
  render() {
    ...
    return (
      <Box title="Children" extraButtons={extraButtons()} isOpen={true}>
        {children?.length ? (
          (children as Array<ITask>).map((child) => (
