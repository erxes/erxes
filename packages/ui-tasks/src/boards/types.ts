...
export interface IConversionStagePurchase extends IStage {
  ...
  inProcessTasksTotalCount: number;
  stayedTasksTotalCount: number;
...
export type BoardCountsQueryResponse = {
  tasksBoardCounts: IBoardCount[];
} & QueryResponse;

export type PipelinesQueryResponse = {
  tasksPipelines: IPipeline[];
  loading: boolean;
  refetch: ({
    boardId,
    type
...
export type PipelineLabelsQueryResponse = {
  tasksPipelineLabels: IPipelineLabel[];
} & QueryResponse;

export type PipelineLabelDetailQueryResponse = {
  tasksPipelineLabelDetail: IPipelineLabel;
} & QueryResponse;
