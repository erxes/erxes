...
export type BoardCountsQueryResponse = {
  taskBoardCounts: IBoardCount[];
} & QueryResponse;

export type PipelinesQueryResponse = {
  taskPipelines: IPipeline[];
  loading: boolean;
  refetch: ({
    boardId,
    type,
...
export type PipelineLabelsQueryResponse = {
  taskPipelineLabels: IPipelineLabel[];
} & QueryResponse;

export type PipelineLabelDetailQueryResponse = {
  taskPipelineLabelDetail: IPipelineLabel;
} & QueryResponse;
