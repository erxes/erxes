...
class Main extends React.Component<FinalProps> {
  ...
  render() {
    ...
    const lastBoard = boardGetLastQuery && boardGetLastQuery.taskBoardGetLast;
    const currentBoard = boardDetailQuery && boardDetailQuery.taskBoardDetail;
