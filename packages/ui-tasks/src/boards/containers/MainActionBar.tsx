...
function Main(props: FinalProps) {
  ...
  const lastBoard = boardGetLastQuery && boardGetLastQuery.tasksBoardGetLast;
  const currentBoard = boardDetailQuery && boardDetailQuery.tasksBoardDetail;
  ...
  const updatedProps = {
    ...
    currentBoard,
    currentPipeline,
    boards: boardsQuery.tasksBoards || []
  };
