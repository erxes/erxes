...
export const EMPTY_CONTENT_PURCHASE = {
  ...
  steps: [
    {
      title: __("Create Boards and tasks Pipeline"),
      description: `${__(
        "Track your entire tasks pipeline from one dashboard"
      )}${__("You can also restrict access to your tasks pipelines")}`,
      url: "/settings/boards/purchase",
      urlText: __("Go to Board & tasks pipeline")
    },
    {
      title: __("Tip: Choose different views"),
      description: __(
        "Click on “Boards, Calendar, Conversions” to filter tasks pipeline"
      ),
      icon: "lightbulb-alt"
    }
  ]
