...
declare global {
  ...
  namespace google.maps {
     ...
     * image tiles.
     */
    class ImageMapType extends google.maps.MVCObject
  ...
  namespace google.maps {
     ...
     * the feature in the KML or GeoRSS markup in which it is d.
     */
  ...
  namespace google.maps {
     ...
     */
    class StyledMapType extends google.maps.MVCObject
      implements google.maps.MapType {
      /**
       * Creates a <code>MapType</code> with a custom style.
       */
  ...
  namespace google.maps.drawing {
    ...
    class DrawingManager extends google.maps.MVCObject {
       ...
       */
      setOptions(
        options: google.maps.drawing.DrawingManagerOptions | null
      ): void;
    }
  }
  namespace google.maps.drawing {
  ...
  namespace google.maps.journeySharing {
    /**
     * Available only in the v=beta channel: https://goo.gle/3oAthT3.
  ...
  namespace google.maps.journeySharing {
     ...
     */
    class FleetEngineDeliveryFleetLocationProvider extends google.maps
       ...
       */
      deliveryVehicleFilterOptions?: google.maps.journeySharing.FleetEngineDeliveryVehicleFilterOptions | null;
      /**
  ...
  namespace google.maps.journeySharing {
     ...
     */
    class FleetEngineDeliveryVehicleLocationProvider extends google.maps
      .journeySharing.LocationProvider {
      /**
       * Available only in the v=beta channel: https://goo.gle/3oAthT3.
       * Delivery Vehicle Location Provider.
  ...
  namespace google.maps.journeySharing {
     ...
     */
    class FleetEngineShipmentLocationProvider extends google.maps.journeySharing
      .LocationProvider {
      /**
       * Available only in the v=beta channel: https://goo.gle/3oAthT3.
       * Shipment location provider.
  ...
  namespace google.maps.journeySharing {
     ...
     */
    class FleetEngineTripLocationProvider extends google.maps.journeySharing
      .LocationProvider {
      /**
       * Available only in the v=beta channel: https://goo.gle/3oAthT3.
       * Trip location provider.
  ...
  namespace google.maps.localContext {
    /**
  ...
  namespace google.maps.visualization {
    /**
