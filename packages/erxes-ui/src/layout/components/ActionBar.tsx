...
function ActionBar({ left, right, background, bottom, zIndex, hasFlex, noBorder }: Props) {
  return (
    <ContentHeader background={background || 'bgLight'} noBorder={noBorder} zIndex={zIndex}>
      <HeaderContent>
