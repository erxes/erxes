...
const boardMutations = {
  ...
  async ghStagesSortItems(
    ...
    graphqlPubsub.publish(`growthhacksPipelinesChanged:${stage.pipelineId}`, {
  ...
  async ghBoardItemUpdateTimeTracking(
    _root,
    {
      _id,
      type,
  ...
  async ghBoardItemsSaveForGanttTimeline(
    _root,
