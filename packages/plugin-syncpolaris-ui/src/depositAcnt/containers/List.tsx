...
class depositContainer extends React.Component<FinalProps, {}> {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    queryParams.contentType = 'contacts:Deposit';
    const updatedProps = {
      ...this.props,
      queryParams,
      syncHistories,
...
export default withProps<Props>(
  ...
  )(withRouter<IRouterProps>(depositContainer)),
);
