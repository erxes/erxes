...
export const setupMessageConsumers = async () => {
  consumeRPCQueue('purchases:create', async ({ subdomain, data }) => {
  ...
  consumeRPCQueue('purchases:remove', async ({ subdomain, data: { _ids } }) => {
    const models = await generateModels(subdomain);
  ...
  consumeRPCQueue('purchases:find', async ({ subdomain, data }) => {
    const models = await generateModels(subdomain);
  ...
  consumeRPCQueue('purchases:count', async ({ subdomain, data }) => {
    const models = await generateModels(subdomain);
  ...
  consumeRPCQueue('purchases:findOne', async ({ subdomain, data }) => {
    const models = await generateModels(subdomain);
  ...
  consumeRPCQueue('purchases:generateAmounts', async (productsData) => {
    return { data: generateAmounts(productsData), status: 'success' };
  });

  consumeRPCQueue('purchases:generateProducts', async ({ subdomain, data }) => {
    return {
