...
import { AddForm } from '@erxes/ui-tickets/src/boards/containers/portable';
import EditForm from '@erxes/ui-tickets/src/boards/containers/editForm/EditForm';
import { IOptions } from '../../types';
import { __ } from '@erxes/ui/src/utils';
import { ITicket } from '../../../tickets/types';
import { SectionBodyItem } from '@erxes/ui/src/layout/styles';
import { ProductName } from '../../../tickets/styles';
  ...
  render() {
    ...
    return (
      <Box title="Children" extraButtons={extraButtons()} isOpen={true}>
        {children?.length ? (
          (children as Array<ITicket>).map((child) => (
