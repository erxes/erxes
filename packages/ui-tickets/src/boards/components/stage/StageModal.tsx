...
export default class StageModal extends React.Component<Props, State> {
  ...
  print = () => {
    ...
    try {
      ...
      const url = `${apiUrl}/pl:documents/print?_id=${selectedDocumentId}&itemIds=${checkedItemIds}&stageId=${this.props.stage._id}&copies=${copies}&width=${width}&brandId=${brandId}&contentype=tickets:stage`;
