...
class WithStages extends Component<WithStagesProps> {
  render() {
    ...
    let groupType = "stage";
    let groups: any[] = stagesQuery.ticketsStages || [];

    if (queryParams.groupBy === "label") {
      groups = pipelineLabelsQuery.ticketsPipelineLabels || [];
      groupType = "label";
    }
    ...
    if (queryParams.groupBy === "assignee") {
      groups = pipelineAssigneeQuery.ticketsPipelineAssignedUsers || [];
      groupType = "assignee";
    }
