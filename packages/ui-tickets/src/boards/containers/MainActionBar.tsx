...
function Main(props: FinalProps) {
  ...
  const lastBoard = boardGetLastQuery && boardGetLastQuery.ticketsBoardGetLast;
  const currentBoard = boardDetailQuery && boardDetailQuery.ticketsBoardDetail;
  ...
  const updatedProps = {
    ...
    currentBoard,
    currentPipeline,
    boards: boardsQuery.ticketsBoards || []
  };
