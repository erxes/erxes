...
class Main extends React.Component<FinalProps> {
  ...
  render() {
    ...
    const lastBoard = boardGetLastQuery && boardGetLastQuery.ticketBoardGetLast;
    const currentBoard = boardDetailQuery && boardDetailQuery.ticketBoardDetail;
    ...
    const props = {
      ...
      currentBoard,
      currentPipeline,
      boards: boardsQuery.ticketBoards || [],
    };
