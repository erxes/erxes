export const STEPS = [
  ...
  {
    title: 'User Guide', /*Fix for Issue#3879| Change: Using Guide -> User Guide*/
    key: 'usingGuide',
    image: '/images/usingGuide.png',
    description:
      'Feature guides for the core erxes platform and native plugins.'  /*Fix for Issue#3879| Change: Features guides for the core expes platform and native plugins -> Feature guides for the core erxes platform and native plugins.*/
  }
];
...
export const BANNER = [
  {
    ...
    key: 'market',
    desc:
      'Looking for plugins outside the scope of your development team? Visit our marketplace to learn more',
    button: 'Go to marketplace',
    icon: 'store',
    background: '#4F33AF',
    img: '/images/shootingStars.png',
    href: 'https://erxes.io/marketplace'
  },
  {
    ...
    background:
      'linear-gradient(0deg, #F883AF -30.54%, #F47FB0 -18.64%, #E772B4 -4.1%, #D25DBB 9.12%, #B53FC4 22.34%, #941ECE 35.56%, #2A1E81 99.02%)',
