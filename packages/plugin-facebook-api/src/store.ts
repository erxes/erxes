...
export const getOrCreateCustomer = async (
  ...
  // console.log(fbUserProfilePic, 'fbUserProfilePic');
...
//   if (!fbUserProfilePic) {
//     throw new Error(
//       'Facebook user profile picture is missing in server response.'
//     );
//   }

//   const user_id = fbUserProfilePic.user.id;
//   const profile = fbUserProfilePic.awsResponse;
//   console.log(fbUserProfilePic, 'fbUserProfilePic');
//   console.log(user_id, 'user_id');
//   console.log(profile, 'profile');

//   let customer = await models.Customers.findOne({ userId: user_id });
//   console.log(fbUser, 'fbUser');
//   if (customer) {
//     return customer;
//   }
