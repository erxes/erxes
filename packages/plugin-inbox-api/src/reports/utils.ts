            ...
            _id: {
              $switch: {
                branches: [
                  ...
                  {
                    case: { $eq: ['$_id', 'facebook-messenger'] },
                    then: 'Facebook Messenger'
                  },
                  {
                    case: { $eq: ['$_id', 'facebook-post'] },
                    then: 'Facebook Post'
                  }
                ],
                default: '$_id'
