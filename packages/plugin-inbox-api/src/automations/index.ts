...
export default {
  constants: {
    actions: [
      {
        type: "widgets:messages.create",
        icon: "messenger",
        label: "Send Widgets Message",
        description: "Send Widgets Message",
        isAvailable: true,
    ...
    triggers: [
      {
        type: "widgets:messages",
        img: "automation3.svg",
        icon: "messenger",
        label: "Widgets Message",
        description:
          "Start with a blank workflow that enrolls and is triggered off widgets messages",
        isCustom: true,
        conditions: [
          {
            type: "direct",
