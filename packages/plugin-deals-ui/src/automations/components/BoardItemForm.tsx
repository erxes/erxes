...
import { PRIORITIES } from '@erxes/ui-deals/src/boards/constants';
import BoardSelect from '@erxes/ui-deals/src/boards/containers/BoardSelect';
import { queries as pipelineQuery } from '@erxes/ui-deals/src/boards/graphql';
import { IPipelineLabel } from '@erxes/ui-deals/src/boards/types';
...
class BoardItemForm extends React.Component<Props, State> {
  ...
  renderSelect() {
    ...
    switch (activeAction.type) {
      ...
      case 'deals:task.create':
        type = 'task';
        break;

      case 'deals:ticket.create':
        type = 'ticket';
        break;

      case 'deals:purchase.create':
        type = 'purchase';
        break;
    }
    ...
    const plIdOnChange = (plId) => {
      client
        ...
        .then((data) => {
          this.setState({ pipelineLabels: data.data.dealPipelineLabels });
        })
        .catch((e) => {
