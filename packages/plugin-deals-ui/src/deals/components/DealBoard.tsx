import Board from '@erxes/ui-deals/src/boards/containers/Board';
import MainActionBar from '@erxes/ui-deals/src/boards/containers/MainActionBar';
import {
  BoardContainer,
  BoardContent,
} from '@erxes/ui-deals/src/boards/styles/common';
