...
import {
  mutations,
  queries,
} from '@erxes/ui-deals/src/settings/boards/graphql';

import Boards from '../components/Boards';
import { BoardsQueryResponse } from '@erxes/ui-deals/src/boards/types';
import ButtonMutate from '@erxes/ui/src/components/ButtonMutate';
import React from 'react';
import { STORAGE_BOARD_KEY } from '@erxes/ui-deals/src/boards/constants';
import { getDefaultBoardAndPipelines } from '@erxes/ui-deals/src/boards/utils';
import { getWarningMessage } from '@erxes/ui-deals/src/boards/utils';
