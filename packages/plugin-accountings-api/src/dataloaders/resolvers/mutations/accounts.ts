...
checkPermission(accountsMutations, 'accountCategoriesAdd', 'manageAccounts');
checkPermission(accountsMutations, 'accountCategoriesEdit', 'manageAccounts');
checkPermission(accountsMutations, 'accountCategoriesRemove', 'manageAccounts');
