  ...
  // TicketCustomProperties
  {
    ...
    filterTypes: [
      ...
      // TAG FILTER
      {
        ...
        fieldQueryVariables: `{"type": "sales:ticket", "perPage": 1000}`,
        multi: true,
      ...
      // CUSTOM PROPERTIES FILTER
      {
        ...
        fieldValueVariable: "_id",
        fieldLabelVariable: "name",
        fieldQueryVariables: `{"contentType": "sales:ticket"}`,
        multi: true,
      ...
      // CUSTOM PROPERTIES FIELD FILTER
      {
        ...
        fieldQueryVariables: `{"contentType": "sales:ticket", "isVisible": true}`,
        logics: [
          {
            logicFieldName: "groupIds",
            logicFieldVariable: "groupIds",
            logicFieldExtraVariable: `{"contentType": "sales:ticket"}`
          }
        ],
        multi: true,
