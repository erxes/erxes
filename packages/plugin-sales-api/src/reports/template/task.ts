...
export const taskCharts = [
  // TaskCustomProperties
  {
    ...
    filterTypes: [
      ...
      // TAG FILTER
      {
        ...
        fieldQueryVariables: `{"type": "sales:task", "perPage": 1000}`,
        multi: true,
      ...
      // CUSTOM PROPERTIES FILTER
      {
        ...
        fieldValueVariable: "_id",
        fieldLabelVariable: "name",
        fieldQueryVariables: `{"contentType": "sales:task"}`,
        multi: true,
      ...
      // CUSTOM PROPERTIES FIELD FILTER
      {
        ...
        fieldQueryVariables: `{"contentType": "sales:task", "isVisible": true}`,
        logics: [
          {
            logicFieldName: "groupIds",
            logicFieldVariable: "groupIds",
            logicFieldExtraVariable: `{"contentType": "sales:task"}`
          }
        ],
        multi: true,
  ...
  // AllTasksIncompleteByDueDate
  {
    ...
    getChartResult: async (
      ...
      const totalCountByDueDate = (tasks || []).reduce(
        (acc, { count, _id }) => {
          acc[_id] = count;
          return acc;
        },
