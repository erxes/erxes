export const commonPaymentParamDefs = `$name: String!, $kind: String!, $status: String, $config: JSON $currency: String`;
export const commonPaymentParams = `name: $name, kind: $kind, status: $status, config: $config, currency: $currency`;
