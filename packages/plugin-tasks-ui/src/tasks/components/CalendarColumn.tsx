import {
  ...
  ColumnContentBody,
  ColumnFooter
} from "@erxes/ui-tasks/src/boards/components/Calendar";
import { AddNew } from "@erxes/ui-tasks/src/boards/styles/stage";
...
import Task from "@erxes/ui-tasks/src/tasks/components/TaskItem";
