...
import { ColumnProps } from "@erxes/ui-tasks/src/boards/components/Calendar";
import {
  calendarColumnQuery,
  onCalendarLoadMore
} from "@erxes/ui-tasks/src/boards/utils";
import { withProps } from "@erxes/ui/src/utils";
import { getMonthTitle } from "@erxes/ui/src/utils/calendar";
import CalendarColumn from "../components/CalendarColumn";
import React from "react";
import { queries } from "@erxes/ui-tasks/src/tasks/graphql";
import {
  TasksQueryResponse,
  TasksTotalCountQueryResponse
} from "@erxes/ui-tasks/src/tasks/types";
