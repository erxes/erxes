...
import { STORAGE_BOARD_KEY } from "@erxes/ui-tasks/src/boards/constants";
...
function BoardsContainer(props: FinalProps) {
  ...
  const boards = boardsQuery.tasksBoards || [];
...
const getRefetchQueries = () => {
  return ["tasksBoards", "tasksBoardGetLast", "tasksPipelines"];
};
