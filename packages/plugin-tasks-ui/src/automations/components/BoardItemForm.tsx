...
import { IPipelineLabel } from "@erxes/ui-tasks/src/boards/types";
import { IUser } from "@erxes/ui/src/auth/types";
import { PRIORITIES } from "@erxes/ui-tasks/src/boards/constants";
...
import { queries as pipelineQuery } from "@erxes/ui-tasks/src/boards/graphql";
type Props = {
  closeModal: () => void;
  ...
  renderSelect() {
    ...
    const plIdOnChange = plId => {
      client
        ...
        .then(data => {
          this.setState({ pipelineLabels: data.data.tasksPipelineLabels });
        })
        .catch(e => {
