...
class BoardItemForm extends React.Component<Props, State> {
  ...
  renderSelect() {
    ...
    switch (activeAction.type) {
      case 'purchases:deal.create':
        type = 'deal';
        break;

      case 'purchases:task.create':
        type = 'task';
        break;

      case 'purchases:ticket.create':
        type = 'ticket';
        break;

      case 'purchases:purchase.create':
        type = 'purchase';
        break;
    }
    ...
    const plIdOnChange = (plId) => {
      client
        ...
        .then((data) => {
          this.setState({ pipelineLabels: data.data.purchasePipelineLabels });
        })
        .catch((e) => {
