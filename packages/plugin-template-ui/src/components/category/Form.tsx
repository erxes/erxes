...
import { FormActions, FormContent, FormFooter, FormHeader, FormTitle } from '../../../../ui-template/src/styles';
            ...
            <>
                <FormContent>
                    ...
                    <FormGroup>
                        ...
                        <Select
                            isClearable
                            defaultValue={categoryOptions.find(option => option.value === parentId)}
