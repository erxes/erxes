import MainActionBar from '@erxes/ui-growthhacks/src/boards/components/MainActionBar';
import { ButtonGroup } from '@erxes/ui-growthhacks/src/boards/styles/header';
import { IBoard, IPipeline } from '@erxes/ui-growthhacks/src/boards/types';
