import DueDateChanger from '@erxes/ui-growthhacks/src/boards/components/DueDateChanger';
import { ArchiveBtn } from '@erxes/ui-growthhacks/src/boards/components/editForm/ArchiveBtn';
import PriorityIndicator from '@erxes/ui-growthhacks/src/boards/components/editForm/PriorityIndicator';
import SelectItem from '@erxes/ui-growthhacks/src/boards/components/SelectItem';
import { PRIORITIES } from '@erxes/ui-growthhacks/src/boards/constants';
import { Watch } from '@erxes/ui-growthhacks/src/boards/containers/editForm/';
import LabelChooser from '@erxes/ui-growthhacks/src/boards/containers/label/LabelChooser';
import { ColorButton } from '@erxes/ui-growthhacks/src/boards/styles/common';
import { ActionContainer } from '@erxes/ui-growthhacks/src/boards/styles/item';
import { IOptions } from '@erxes/ui-growthhacks/src/boards/types';
import ChecklistAdd from '@erxes/ui-growthhacks/src/checklists/components/AddButton';
import Icon from '@erxes/ui/src/components/Icon';
import { __ } from '@erxes/ui/src/utils/core';
import { IGrowthHack } from '../../types';
import React from 'react';
import { HACKSTAGES } from '@erxes/ui-growthhacks/src/boards/constants';
