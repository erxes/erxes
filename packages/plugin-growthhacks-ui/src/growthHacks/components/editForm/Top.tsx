import { PriorityIndicator } from '@erxes/ui-growthhacks/src/boards/components/editForm';
import Move from '@erxes/ui-growthhacks/src/boards/containers/editForm/Move';
