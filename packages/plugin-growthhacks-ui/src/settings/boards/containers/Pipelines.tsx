...
} from '@erxes/ui-growthhacks/src/boards/types';
...
import { queries as boardQueries } from '@erxes/ui-growthhacks/src/boards/graphql';
...
class PipelinesContainer extends React.Component<FinalProps> {
  render() {
    ...
    const pipelines = pipelinesQuery.ghPipelines || [];
    ...
    const extendedProps = {
      ...
      currentBoard: boardDetailQuery
        ? boardDetailQuery?.ghBoardDetail
        : undefined,
    };
