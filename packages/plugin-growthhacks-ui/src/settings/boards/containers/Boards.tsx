...
import {
  mutations,
  queries,
} from '@erxes/ui-growthhacks/src/settings/boards/graphql';

import Boards from '../components/Boards';
import { BoardsQueryResponse } from '@erxes/ui-growthhacks/src/boards/types';
import ButtonMutate from '@erxes/ui/src/components/ButtonMutate';
import React from 'react';
import { STORAGE_BOARD_KEY } from '@erxes/ui-growthhacks/src/boards/constants';
import { getDefaultBoardAndPipelines } from '@erxes/ui-growthhacks/src/boards/utils';
import { getWarningMessage } from '@erxes/ui-growthhacks/src/boards/utils';
...
class BoardsContainer extends React.Component<FinalProps> {
  render() {
    ...
    const boards = boardsQuery.ghBoards || [];
