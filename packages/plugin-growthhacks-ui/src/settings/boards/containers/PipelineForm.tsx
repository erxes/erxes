...
import { IPipeline } from '@erxes/ui-growthhacks/src/boards/types';
import PipelineForm from '../components/PipelineForm';
import React from 'react';
import Spinner from '@erxes/ui/src/components/Spinner';
import { gql } from '@apollo/client';
import { graphql } from '@apollo/client/react/hoc';
import { queries } from '@erxes/ui-growthhacks/src/settings/boards/graphql';
...
class PipelineFormContainer extends React.Component<FinalProps> {
  render() {
    ...
    const stages = stagesQuery ? stagesQuery.ghStages : [];
...
export default withProps<Props>(
  compose(
    graphql(gql(tagQueries.tags), {
      name: 'tagsQuery',
      options: (props: Props) => ({
        variables: { type: `growthhacks:${props.type}` },
      }),
    }),
