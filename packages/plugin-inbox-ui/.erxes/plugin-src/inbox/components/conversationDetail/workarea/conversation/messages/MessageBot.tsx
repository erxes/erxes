...
import xss from 'xss';
import { IBotData, IMessage } from '@erxes/ui-inbox/src/inbox/types';
import { MessageBody, MessageContent, MessageItem } from '@erxes/ui-inbox/src/inbox/components/conversationDetail/workarea/conversation/styles';
