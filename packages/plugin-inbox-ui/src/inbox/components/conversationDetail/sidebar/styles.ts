...
import { CardItem } from '@erxes/ui-inbox/src/components/conversationDetail/workarea/conversation/messages/bot/styles';
import {
  FormTable,
  MessageBody,
  MessageContent,
  MessageItem,
  UserInfo
} from '@erxes/ui-inbox/src/components/conversationDetail/workarea/conversation/styles';
import {
  AttachmentItem,
  ...
  Reply,
  RightSide
} from '@erxes/ui-inbox/src/components/conversationDetail/workarea/mail/style';
