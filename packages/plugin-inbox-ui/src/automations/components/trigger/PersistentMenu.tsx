...
type FinalProps = {
  botQueryResponse: { widgetsBootMessengerBot: any } & QueryResponse;
} & Props;
...
function PersistentMenuSelector({
  ...
  const { widgetsBootMessengerBot, loading } = botQueryResponse || {};

  if (loading) {
    return <Spinner objective />;
  }

  const { persistentMenus = [] } = widgetsBootMessengerBot || {};
