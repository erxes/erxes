  ...
  automationBots: [
    {
      name: "messenger-bots",
      label: "Messenger",
      description: "Generate Messenger Bots",
      logo: "/images/integrations/messenger.png",
      list: "./messenger-bots",
      createUrl: "/settings/widgets-messenger-bot/create",
      totalCountQuery:
        "query WidgetsbootMessengerBotsTotalCount { widgetsBootMessengerBotsTotalCount }"
    }
  ],
  menus: [
    {
