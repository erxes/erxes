...
export interface IPermissionGroupModel extends Model<IPermissionGroup> {
...
export const permissionGroupSchema = new Schema<IPermissionGroup>({
...
export const generatePermissionGroupModel = (
  ...
  models.PermissionGroup = con.model<IPermissionGroup, IPermissionGroupModel>(
    'forum_permission_groups',
