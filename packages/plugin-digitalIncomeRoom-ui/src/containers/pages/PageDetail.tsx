...
const PageDetailContainer = (props: FinalProps) => {
  ...
  if (pageDetailQuery) {
    page = pageDetailQuery.digitalIncomeRoomPageDetail;
  }

  const pagesMain = pagesMainQuery.digitalIncomeRoomPagesMain || {};
  const contentTypes = typesQuery.digitalIncomeRoomContentTypes || [];
