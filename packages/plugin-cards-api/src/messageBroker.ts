...
export const initBroker = async cl => {
  ...
  consumeRPCQueue(
    ...
    async ({ subdomain, data }) => {
      ...
      return {
        status: 'success',
        data: await models.Tickets.find(
          data
        ).lean()
      };
    }
  ...
  consumeRPCQueue(
    ...
    async ({ subdomain, data }) => {
      ...
      return {
        status: 'success',
        data: await models.Tickets.findOne(
          data
        ).lean()
      };
    }
  ...
  consumeRPCQueue(
    ...
    async ({ subdomain, data: { _ids } }) => {
      ...
      return {
        status: 'success',
        data: await models.Tickets.removeTickets(
          _ids
        )
      };
    }
  ...
  consumeRPCQueue(
    ...
    async ({ subdomain, data }) => {
      ...
      return {
        status: 'success',
        data: await models.Stages.findOne(
          data
        ).lean()
      };
    }
  ...
  consumeRPCQueue(
    ...
    async ({ subdomain, data }) => {
      ...
      return {
        status: 'success',
        data: await models.Tasks.findOne(
          data
        ).lean()
      };
    }
  ...
  consumeRPCQueue(
    ...
    async ({ subdomain, data }) => {
      ...
      return {
        status: 'success',
        data: await models.Pipelines.find(
          data
        ).lean()
      };
    }
  ...
  consumeQueue(
    ...
    async ({
      ...
      return {
        status: 'success',
        data: await models.Checklists.removeChecklists(
          type,
          itemIds
        )
      };
  ...
  consumeRPCQueue(
    ...
    async ({ subdomain, data }) => {
      ...
      return {
        status: 'success',
        data: await conversationConvertToCard(
          models,
          subdomain,
          data
        )
  ...
  consumeRPCQueue(
    ...
    async ({ subdomain, data }) => {
      ...
      return {
        status: 'success',
        data: await models.Deals.findOne(
          data
        ).lean()
      };
    }
  ...
  consumeRPCQueue(
    ...
    async ({
      ...
      return {
        data: await models.Tickets.updateMany(
          selector,
          modifier
        ),
        status: 'success'
  ...
  consumeRPCQueue(
    ...
    async ({
      ...
      return {
        data: await models.Tasks.updateMany(
          selector,
          modifier
        ),
        status: 'success'
  ...
  consumeRPCQueue(
    ...
    async ({
      ...
      return {
        data: await models.Deals.updateMany(
          selector,
          modifier
        ),
        status: 'success'
  ...
  consumeRPCQueue(
    ...
    async ({
      ...
      return {
        data: await models.Deals.updateOne(
          selector,
          modifier
        ),
        status: 'success'
  ...
  consumeRPCQueue(
    ...
    async ({
      ...
      const stage = await models.Stages.getStage(
        item.stageId
      );
      const pipeline = await models.Pipelines.getPipeline(
        stage.pipelineId
      );
      const board = await models.Boards.getBoard(
        pipeline.boardId
      );
  ...
  consumeQueue(
    ...
    async ({
      subdomain,
      data: { addedTypeIds, removedTypeIds, doc }
    }) => {
      const targetTypes = [
        'deal',
        'task',
      ...
      if (
        ...
        for (const typeId of addedTypeIds.concat(
          removedTypeIds
        )) {
          await publishHelper(
            subdomain,
