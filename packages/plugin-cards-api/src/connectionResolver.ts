...
import { IChecklistItemModel, loadClass as loadChecklistClass, loadItemClass } from './models/Checklists';
...
import { IBoardDocument, IPipelineDocument, IStageDocument } from './models/definitions/boards';
...
export const loadClasses = (db: mongoose.Connection, subdomain: string): IModels => {
  ...
  models.GrowthHacks = db.model<IGrowthHackDocument, IGrowthHackModel>('growth_hacks', loadGrowthHackClass(models, subdomain));
