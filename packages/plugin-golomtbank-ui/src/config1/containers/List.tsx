...
import { ConfigsListQueryResponse } from "../../scheme/configTypes";
...
export default function ListContainer(props: Props) {
  ...
  const isSettings = location.pathname === "/config/golomtBank";
  ...
  const [removeMutation] = useMutation(gql(mutations.editMutation));
  ...
  const configs = (data && data.golomtBankConfigsList.list) || [];

  const totalCount = (data && data.golomtBankConfigsList.totalCount) || 0;
