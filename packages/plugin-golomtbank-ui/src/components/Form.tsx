...
class Golomtbank extends React.Component<Props, State> {
    ...
    return (
      <>
        ...
        <ControlWrapper>
          <Indicator>
            {__('You are creating')}
            <strong> {__('Golomtbank')}</strong> {__('integration')}
          </Indicator>
          <Button.Group>
            ...
            <Preview fullHeight={true}>
              <ImageWrapper>
                <TextWrapper>
                  ...
                  <p>
                    {__(
                      'Connect your Golomtbank to start receiving emails in your team inbox'
                    )}
                  </p>
