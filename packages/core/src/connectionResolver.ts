//packages/core/src/connectionResolver.ts
...
import {
 IAutoNumberingModel,
 loadAutoNumberingClass
} from './db/models/AutoNumbering';
...
export interface IModels {
 ...
 AutoNumbering: IAutoNumberingModel;
}
...
export const loadClasses = (
 ...
 models.AutoNumbering = db.model<IAutoNumberingDocument, IAutoNumberingModel>(
   'auto_numberings',
   loadAutoNumberingClass(models)
 );
