...
class PerformSidebar extends React.Component<Props, State> {
  constructor(props) {
    super(props);
            ...
            <List id="SettingsSidebar">
              ...
              <FormGroup>
                ...
                <SelectBranches
                  ...
                  onSelect={(branchId) =>
                    this.setFilter("inBranchId", branchId)
                  }
                  multi={false}
                />
              </FormGroup>
              ...
              <FormGroup>
                ...
                <SelectBranches
                  ...
                  onSelect={(branchId) =>
                    this.setFilter("outBranchId", branchId)
                  }
                  multi={false}
                />
              </FormGroup>
