...
const ticketChecklistsChanged = (checklist: IChecklistsEdit) => {
  graphqlPubsub.publish(
    `ticketChecklistsChanged:${checklist.contentType}:${checklist.contentTypeId}`,
    {
...
const ticketChecklistDetailChanged = (_id: string) => {
  graphqlPubsub.publish(`ticketChecklistDetailChanged:${_id}`, {
...
const checklistMutations = {
  ...
  async ticketChecklistsAdd(
    ...
    ticketChecklistsChanged(checklist);
  ...
  async ticketChecklistsEdit(
    ...
    ticketChecklistDetailChanged(_id);
  ...
  async ticketChecklistItemsAdd(
    ...
    ticketChecklistDetailChanged(checklistItem.checklistId);
   ...
   */
  async ticketChecklistItemsEdit(
    _root,
    ...
    ticketChecklistDetailChanged(updated.checklistId);
   ...
   */
  async ticketChecklistItemsRemove(
    _root,
    { _id }: { _id: string },
    { user, models, subdomain }: IContext
  ) {
  ...
  async ticketChecklistItemsOrder(
    _root,
