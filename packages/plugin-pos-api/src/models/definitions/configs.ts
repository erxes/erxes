...
export const configSchema = schemaHooksWrapper(
  new Schema({
    _id: field({ pkey: true }),
    ...
    token: field({
      type: String,
      label: 'Token generated at erxes-api'
    }),
...
export const productGroupSchema: any = schemaHooksWrapper(
  new Schema({
    _id: field({ pkey: true }),
    name: { type: String },
