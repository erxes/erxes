...
import { ITemplateCategory, TemplateCategoryDocument, templateCategorySchema } from './definitions/templates';
import { escapeRegExp } from '@erxes/api-utils/src/core';

type ITemplateCategoryDocument = Omit<ITemplateCategory, '_id' | 'createdAt' | 'updatedAt' | 'createdBy' | 'updatedBy'>

export interface ITemplateCategoryModal extends Model<TemplateCategoryDocument> {
    getTemplateCategory(_id: string): Promise<TemplateCategoryDocument>;
    createTemplateCategory(doc: ITemplateCategoryDocument, user?: any): Promise<TemplateCategoryDocument>;
    updateTemplateCategory(_id: string, doc: ITemplateCategoryDocument, user?: any): Promise<TemplateCategoryDocument>;
...
export const loadTemplateCategoryClass = models => {
    ...
    class Category {
        ...
        public static async createTemplateCategory(doc: ITemplateCategoryDocument, user?: any) {
            ...
            const category = await models.TemplateCategories.create({
                ...doc,
                order,
                createdAt: new Date(),
                updatedAt: new Date(),
        ...
        public static async updateTemplateCategory(_id: string, doc: ITemplateCategoryDocument, user?: any) {
            ...
            const updatedCategory = await models.TemplateCategories.findOneAndUpdate({ _id }, {
                ...doc,
                updatedAt: new Date(),
                updatedBy: user?._id,
            }, { new: true });
            ...
            childCategories.forEach(async (childCategory) => {
                ...
                await models.TemplateCategories.updateOne(
        ...
        public static async removeTemplateCategory(_id: string) {
            const category = await models.TemplateCategories.findOneAndDelete({ _id });
