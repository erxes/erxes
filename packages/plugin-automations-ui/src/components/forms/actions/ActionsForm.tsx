...
function ActionsForm({ actionsConst }: Props) {
  ...
  function renderBox(action, isFavourite, index) {
      ...
      >
        ...
        >
          <div
            ...
            onClick={e => onFavourite(action, e)}
          >
