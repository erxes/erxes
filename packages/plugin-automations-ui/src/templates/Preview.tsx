...
import { ScratchNode as CommonScratchNode, Trigger } from '../components/editor/styles';
import Icon from "@erxes/ui/src/components/Icon";
import { BRANCH_HANDLE_OPTIONS, DEFAULT_HANDLE_OPTIONS, DEFAULT_HANDLE_STYLE } from '../components/editor/constants';
...
const CustomNode = ({ id, data }) => {
    const handleOptions: HandleProps[] = data?.actionType === "if" ? BRANCH_HANDLE_OPTIONS : DEFAULT_HANDLE_OPTIONS;
