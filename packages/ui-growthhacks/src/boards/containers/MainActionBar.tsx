...
class Main extends React.Component<FinalProps> {
  ...
  render() {
    ...
    const lastBoard = boardGetLastQuery && boardGetLastQuery.ghBoardGetLast;
    const currentBoard = boardDetailQuery && boardDetailQuery.ghBoardDetail;
