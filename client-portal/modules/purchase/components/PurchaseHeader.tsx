...
import PurchaseForm from '../containers/Form';
...
export default class PurchaseHeader extends React.Component<Props, State> {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <>
        <HeaderWrapper>
          <h4>{this.props.purchaseLabel}</h4>
          <div className="right">
            <Button
              btnStyle="success"
              uppercase={false}
        ...
        <Modal
          content={() => <PurchaseForm closeModal={this.showModal} />}
