...
function HomeContainer(props: Props) {
    ...
    const getRefetchQueries = () => {
      ...
      const usersGroups = usersGroupQuery.loading ? [] : usersGroupQuery.data.usersGroups || [];
    
      return <Home configsEnvQuery={configsEnvQuery} usersGroups={usersGroups} renderButton={renderButton} {...props} />
}
