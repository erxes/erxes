...
> _❗_❗_❗ WARNING: This repository is copyrighted (unlike our [main repo](https://github.com/erxes/erxes)). You are not allowed to use this code to host your own **SaaS** version of <a href="https://erxes.io/signin-with-magiclink" target="_blank">erxes.io</a> without obtaining a proper license or prior agreement first❗
