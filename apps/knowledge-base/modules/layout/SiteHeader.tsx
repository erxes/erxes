...
export const SiteHeader = ({ title }: { title: string }) => {
  ...
  // Navigating away closes the menu, derived during render instead of in an effect.
  ...
  return (
    <header className="relative z-20 bg-hero px-4 text-white sm:px-6">
      <div className="mx-auto flex h-20 w-full max-w-6xl items-center justify-between gap-4">
                  ...
                  {navItems.map((item) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          className={cn(
                            'mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-lg bg-subtle text-muted',
