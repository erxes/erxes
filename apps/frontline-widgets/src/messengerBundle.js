  ...
  var p = (e, t, n) =>
    new Promise((a, m) => {
      var i = (c) => {
        ...
        g = (c) => (c.done ? a(c.value) : Promise.resolve(c.value).then(i, s));
      g((n = n.apply(e, t)).next());
    });
  var M = `#erxes-messenger-container {
  position: fixed;
  bottom: 0;
  right: 0;
  z-index: 2147483647;
...
`;
  ...
  var k = localStorage.getItem('theme'),
    ...
    H =
      (B = window.matchMedia) == null
        ? void 0
        : B.call(window, '(prefers-color-scheme: dark)').matches;
  k === 'dark' || (!k && H)
  ...
  var y =
    ...
    L = '',
    A = !1,
    V = 'erxes-messenger-container',
    F = 'erxes-messenger-iframe',
    W = `
  ...
  d.className = 'erxes-messenger-frame';
  ...
  function U() {
    (h && document.getElementsByTagName('head')[0].removeChild(h),
    ...
    G = () =>
      p(void 0, null, function* () {
        ...
        if (
          ((o =
            l.contentDocument ||
            ((e = l == null ? void 0 : l.contentWindow) == null
              ? void 0
              : e.document)),
          o)
        ) {
  ...
  C.className = 'erxes-launcher-container';
  var l = document.createElement('iframe');
  l.id = 'erxes-launcher';
  l.className = 'erxes-launcher';
  l.src = 'about:blank';
  d.appendChild(r);
  C.appendChild(l);
  ...
  var Z = () =>
      p(void 0, null, function* () {
        ...
        ((r.style.display = 'block'), q(e), Y(e), (l.style.opacity = '1'));
      }),
    K = () => localStorage.getItem('erxes') || '{}',
    Q = (e, t) => {
      let n = window.Erxes || {};
    ...
    Y = (e) => {
      var i, s, g;
      let t = (i = window.erxesSettings) == null ? void 0 : i.messenger,
        n = localStorage.getItem('theme'),
        a =
          (g =
            (s = window.matchMedia) == null
              ? void 0
              : s.call(window, '(prefers-color-scheme: dark)')) == null
            ? void 0
            : g.matches,
        m = n === 'dark' || (!n && a) ? 'dark' : 'light';
      e.postMessage(
        { fromPublisher: !0, settings: t, storage: K(), theme: m },
        '*',
      );
    };
  ...
  var J = () => {
    ...
    _ = (e) =>
      p(void 0, null, function* () {
        ...
        if (
          ...
          let { connectionInfo: n } = t,
            { widgetsMessengerConnect: a } = n || {},
            { uiOptions: m } = a || {};
          if (!m) return console.error('Messenger: uiOptions is not defined');
          ...
          ((A = !!c),
            (f = A ? `url(${L}/read-file?key=${encodeURIComponent(c)})` : f),
            (i.style.cssText = `
      width: 48px;
      height: 48px;
      ...
      background-position: center;
    `),
            E && ((i.style.backgroundImage = 'none'), (i.innerHTML = W)));
        }
      });
  ...
  window.addEventListener('message', (e) =>
    p(void 0, null, function* () {
      var i;
      let { data: t } = e,
        { isVisible: n, message: a, isSmallContainer: m } = t || {};
      if (t.fromErxes && t.source === 'fromMessenger') {
        ...
        (y && document.body.classList.toggle('widget-mobile', n),
          a === 'expandMessenger' &&
            (d.classList.remove('erxes-messenger-shown'),
            d.classList.add('erxes-messenger-expand')),
          a === 'collapseMessenger' &&
            (d.classList.remove('erxes-messenger-expand'),
            d.classList.add('erxes-messenger-shown')),
          a === 'messenger' &&
            (y && n ? O() : U(),
            n
              ? ((E = !0),
                d.classList.add('erxes-messenger-shown'),
                d.classList.remove('erxes-messenger-hidden'),
              ...
              : ((E = !1),
                ...
                d.classList.add('erxes-messenger-hidden'),
                (s.style.backgroundImage = f),
                (s.style.backgroundSize = A ? '32px' : '18px'),
                (s.innerHTML = ''),
                v(X))),
          'isSmallContainer' in (t || {}) && b.classList.toggle('small', m));
      }
    }),
  );
})();
