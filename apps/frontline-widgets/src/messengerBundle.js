"use strict";(()=>{var p=(e,t,n)=>new Promise((i,l)=>{var d=c=>{try{h(n.next(c))}catch(u){l(u)}},s=c=>{try{h(n.throw(c))}catch(u){l(u)}},h=c=>c.done?i(c.value):Promise.resolve(c.value).then(d,s);h((n=n.apply(e,t)).next())});var C=`#erxes-messenger-container {
  position: fixed;
  bottom: 0;
  right: 0;
  z-index: 2147483647;
