  ...
  var u = (t, e, n) =>
    new Promise((g, c) => {
      var o = (r) => {
        ...
        h = (r) => (r.done ? g(r.value) : Promise.resolve(r.value).then(o, d));
      h((n = n.apply(t, e)).next());
    });
  var y = `#erxes-messenger-container {
  position: fixed;
  bottom: 0;
  right: 0;
  z-index: 2147483647;
...
`;
  ...
  var b =
    ...
    v = '',
    A = !1,
    W = 'erxes-messenger-container',
    X = 'erxes-messenger-iframe',
    N = `
  ...
  f.id = W;
  b && (document.documentElement.style.marginBottom = '72px');
  var l = document.createElement('div');
  l.className = 'erxes-messenger-frame';
  ...
  var T = (t) => {
    ...
    return e && e instanceof HTMLScriptElement
      ? e.src.replace('messengerBundle.js', '')
      : '';
  };
  s.src = T('messenger');
  ...
  var C = (t) => {
      ((t.type === 'keyup' && t.key === 'Enter') || t.type === 'click') && O();
    },
    H = () =>
  ...
  E.className = 'erxes-launcher-container';
  ...
  var S = () =>
      u(void 0, null, function* () {
        ...
        ((s.style.display = 'block'), V(t), R(t), (a.style.opacity = '1'));
      }),
    I = () => localStorage.getItem('erxes') || '{}',
    F = (t, e) => {
    ...
    R = (t) => {
      ...
      t.postMessage({ fromPublisher: !0, settings: e, storage: I() }, '*');
    };
    ...
    U = (t) =>
      u(void 0, null, function* () {
        ...
        if (
          ...
          let { primary: d, logo: h } = c,
            r = h,
            p = d == null ? void 0 : d.DEFAULT,
            L = d == null ? void 0 : d.foreground;
          ((A = !!r),
            (x = A ? `url(${v}/read-file?key=${encodeURIComponent(r)})` : x),
            (o.style.cssText = `
      width: 48px;
      height: 48px;
  ...
  window.addEventListener('message', (t) =>
    u(void 0, null, function* () {
      let { data: e } = t,
        { isVisible: n, message: g, isSmallContainer: c } = e || {};
      if (e.fromErxes && e.source === 'fromMessenger') {
        let o = i == null ? void 0 : i.querySelector('.erxes-launcher');
        if (!o)
          return console.error('Messenger: launcher element is not defined');
        (b && document.body.classList.toggle('widget-mobile', n),
          g === 'messenger' &&
            (b && n ? P() : z(),
            n
              ? (l.classList.add('erxes-messenger-shown'),
                l.classList.remove('erxes-messenger-hidden'),
                (o.style.backgroundImage = 'none'),
                (o.innerHTML = N))
              : (l.classList.remove('erxes-messenger-shown'),
                l.classList.add('erxes-messenger-hidden'),
                (o.style.backgroundImage = x),
                (o.style.backgroundSize = A ? '32px' : '18px'),
                (o.innerHTML = ''))),
          f.classList.toggle('small', c));
      }
    }),
  );
})();
